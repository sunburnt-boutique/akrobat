...
#
#     from akrobat import metadata
#
# However, when we do this, we also import `akrobat/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'akrobat_cli = akrobat.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'akrobat_gui = akrobat.gui:entry_point'
        # ]
    }
)
